...
export function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://formspree.io/f/mjkwndkq", {
      method: "POST",
      headers: {
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-400">
              Feel free to reach out for any collaboration, queries, or just to say hi!
            </p>
          </div>

          <div className="bg-gray-900 text-white rounded-2xl shadow-lg p-8 border border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-600 bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                    required
                  />
                </div>
                <div>
